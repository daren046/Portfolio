  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0">
        <div
          className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_20%,rgba(80,104,224,0.12),transparent_55%),radial-gradient(ellipse_at_center,transparent_40%,rgba(0,0,0,0.9)_100%)]"
        />
        {/* Animated Grid */}
        <motion.div
      ...
      <div className="container-custom section-padding text-center relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            animate={nameComplete ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 }}
            transition={{ duration: 0.55, delay: nameComplete ? 0.15 : 0 }}
          ...
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            animate={nameComplete ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 }}
            transition={{ duration: 0.55, delay: nameComplete ? 0.35 : 0 }}
            className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16"
          >
            <MagneticButton
              onClick={() => document.querySelector('#portfolio')?.scrollIntoView({ behavior: 'instant', block: 'start' })}
              strength={0.35}
              className="group relative rounded-xl border-2 border-white text-white transition-colors duration-300 hover:bg-white hover:text-black px-8 py-4 font-mono tracking-wider ring-1 ring-white/10"
            >
              <motion.div
                initial={{ x: "-100%" }}
                whileHover={{ x: "0%" }}
            ...
            <a href={CV_PDF} download="CV_Daren_Tagnan.pdf" target="_blank" rel="noopener noreferrer">
              <MagneticButton
                strength={0.35}
                className="group relative rounded-xl border-2 border-white/40 text-white transition-colors duration-300 hover:border-white hover:bg-white hover:text-black px-8 py-4 font-mono tracking-wider ring-1 ring-white/10"
              >
                <motion.div
        ...
        <motion.button
          ...
          transition={{ delay: nameComplete ? 0.65 : 0, duration: 0.45 }}
